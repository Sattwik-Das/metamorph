...
<header
          data-testid="topnav"
          className="sticky top-0 z-sticky flex h-(--layout-header-outer-height) w-full items-center justify-between gap-4 md:gap-18 px-4 py-6 text-primary motion-reduce:animate-none md:px-(--nav-padding-horizontal) pointer-events-none"
        >
          <div
            aria-hidden="true"
          ...
          <div className="pointer-events-auto relative flex min-w-0 items-center gap-5">
            ...
            >
              <div className="flex items-center gap-2">
                <img src="/logos/logo-image.png" alt="Logo Icon" className="h-6 md:h-8 w-auto object-contain brightness-0" />
                <img src="/logos/logotext.png" alt="Logo Text" className="h-4 md:h-5 w-auto object-contain hidden lg:block grayscale brightness-0 opacity-90" />
              </div>
            </a>
