...
export function SectionGetCosmos() {
  return (
    <>
<motion.section className="relative -mb-20 flex h-[350px] flex-col items-center justify-center gap-6 px-4 md:mb-0 lg:h-[573px] lg:px-0" initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} viewport={{ once: true, margin: "-100px" }}>
                ...
                <div className="relative z-10 flex w-full max-w-[360px] flex-col items-center gap-4 lg:w-auto lg:max-w-none lg:gap-6">
                  <a
                    ...
                    className="w-full cursor-pointer rounded-full bg-button-primary px-8 py-5 text-center font-cosmos-oracle text-[18px] text-inverted leading-none tracking-[-0.72px] transition-colors hover:bg-hover-primary lg:hidden"
                  >
                    Download the app
                  </a>
                  <a
                    className="hidden w-full cursor-pointer rounded-full bg-button-primary px-12 py-8 text-center font-cosmos-oracle text-[58px] text-inverted leading-none tracking-[-2.32px] transition-colors hover:bg-hover-primary lg:block lg:w-auto"
                    href="/start"
                  >
                    Sign up for Cosmos
                  </a>
                  ...
                  >
                    <div className="contents">Download the app</div>
                  </button>
                </div>
              </motion.section>
    </>
